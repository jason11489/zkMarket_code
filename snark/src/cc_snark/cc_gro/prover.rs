use crate::cc_snark::cc_gro::{r1cs_to_qap::R1CSToQAP, CcGroth16, Proof, ProvingKey, VerifyingKey};
...
impl<E: Pairing, QAP: R1CSToQAP> CcGroth16<E, QAP> {
    ...
    fn create_proof_with_assignment(
        ...
        let l_aux_acc = E::G1::msm_bigint(&pk.l_query, &aux_assignment[DATA_SET.Data_size..]);
        ...
        let gamma_abc_inputs_acc_without_one = E::G1::msm_bigint(
            ...
            &aux_assignment[0..DATA_SET.Data_size],
        );
